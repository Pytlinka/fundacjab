...
class Admin {
	...
	public function init_menus() {
		...
		// add_submenu_page(
		// 	'blockart',
		// 	esc_html__( 'Free vs Pro', 'blockart' ),
		// 	esc_html__( 'Free vs Pro', 'blockart' ),
		// 	'manage_options',
		// 	'blockart#/free-vs-pro',
		// 	array( $this, 'markup' )
		// );
	...
	public function enqueue() {
		if ( version_compare( $GLOBALS['wp_version'], '6.2', '<=' ) ) {
			...
			wp_register_script(
				'react',
				BLOCKART_PLUGIN_DIR_URL . "/lib/react$suffix.js",
				SCRIPT_DEBUG ? array(
			...
			wp_register_script( 'react-dom', BLOCKART_PLUGIN_DIR_URL . "/lib/react-dom$suffix.js", array( 'react' ), '18.0.0', true );
		}
