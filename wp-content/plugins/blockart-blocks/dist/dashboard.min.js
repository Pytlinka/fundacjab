...
`,CSSPolyfill=()=>(0,jsx_runtime.jsx)(Global,{styles:vhPolyfill}),CSSReset=({scope=""})=>(0,jsx_runtime.jsx)(Global,{styles:chunk_B4LBJQ3X_css`
    ...
    transparent 100%
        ...
        `),()=>{document.head.removeChild(style)}}},[isPresent]),external_React_.createElement(PopChildMeasure,{isPresent:isPresent,childRef:ref,sizeRef:size},external_React_.cloneElement(children,{ref:ref}))}const PresenceChild=({children,initial,isPresent,onExitComplete,custom,presenceAffectsLayout,mode})=>{const presenceChildren=useConstant(newChildrenMap),id=(0,external_React_.useId)();presenceAffectsLayout=(0,external_React_.useMemo)(()=>({id:id,initial:initial,isPresent:isPresent,custom:custom,onExitComplete:childId=>{presenceChildren.set(childId,!0);for(const isComplete of presenceChildren.values())if(!isComplete)return;onExitComplete&&onExitComplete()},register:childId=>(presenceChildren.set(childId,!1),()=>presenceChildren.delete(childId))}),presenceAffectsLayout?void 0:[isPresent]);return(0,external_React_.useMemo)(()=>{presenceChildren.forEach((_,key)=>presenceChildren.set(key,!1))},[isPresent]),external_React_.useEffect(()=>{isPresent||presenceChildren.size||!onExitComplete||onExitComplete()},[isPresent]),"popLayout"===mode&&(children=external_React_.createElement(PopChild,{isPresent:isPresent},children)),external_React_.createElement(PresenceContext.Provider,{value:presenceAffectsLayout},children)};function newChildrenMap(){return new Map}const getChildKey=child=>child.key||"";const AnimatePresence=({children,custom,initial=!0,onExitComplete,exitBeforeEnter,presenceAffectsLayout=!0,mode="sync"})=>{invariant(!exitBeforeEnter,"Replace exitBeforeEnter with mode='wait'");const forceRender=(0,external_React_.useContext)(LayoutGroupContext).forceRender||function(){const isMounted=useIsMounted(),[forcedRenderCount,setForcedRenderCount]=(0,external_React_.useState)(0),forceRender=(0,external_React_.useCallback)(()=>{isMounted.current&&setForcedRenderCount(forcedRenderCount+1)},[forcedRenderCount]);return[(0,external_React_.useCallback)(()=>frame_frame.postRender(forceRender),[forceRender]),forcedRenderCount]}()[0],isMounted=useIsMounted(),filteredChildren=function(children){const filtered=[];return external_React_.Children.forEach(children,child=>{(0,external_React_.isValidElement)(child)&&filtered.push(child)}),filtered}(children);let childrenToRender=filteredChildren;const exitingChildren=(0,external_React_.useRef)(new Map).current,presentChildren=(0,external_React_.useRef)(childrenToRender),allChildren=(0,external_React_.useRef)(new Map).current,isInitialRender=(0,external_React_.useRef)(!0);var callback;if(useIsomorphicLayoutEffect(()=>{isInitialRender.current=!1,function(children,allChildren){children.forEach(child=>{var key=getChildKey(child);allChildren.set(key,child)})}(filteredChildren,allChildren),presentChildren.current=childrenToRender}),callback=()=>{isInitialRender.current=!0,allChildren.clear(),exitingChildren.clear()},(0,external_React_.useEffect)(()=>()=>callback(),[]),isInitialRender.current)return external_React_.createElement(external_React_.Fragment,null,childrenToRender.map(child=>external_React_.createElement(PresenceChild,{key:getChildKey(child),isPresent:!0,initial:!!initial&&void 0,presenceAffectsLayout:presenceAffectsLayout,mode:mode},child)));childrenToRender=[...childrenToRender];const presentKeys=presentChildren.current.map(getChildKey),targetKeys=filteredChildren.map(getChildKey);var numPresent=presentKeys.length;for(let i=0;i<numPresent;i++){var key=presentKeys[i];-1!==targetKeys.indexOf(key)||exitingChildren.has(key)||exitingChildren.set(key,void 0)}return"wait"===mode&&exitingChildren.size&&(childrenToRender=[]),exitingChildren.forEach((component,key)=>{if(-1===targetKeys.indexOf(key)){var child=allChildren.get(key);if(child){var insertionIndex=presentKeys.indexOf(key);let exitingComponent=component;exitingComponent||(exitingComponent=external_React_.createElement(PresenceChild,{key:getChildKey(child),isPresent:!1,onExitComplete:()=>{exitingChildren.delete(key);const leftOverKeys=Array.from(allChildren.keys()).filter(childKey=>!targetKeys.includes(childKey));leftOverKeys.forEach(leftOverKey=>allChildren.delete(leftOverKey)),presentChildren.current=filteredChildren.filter(presentChild=>{presentChild=getChildKey(presentChild);return presentChild===key||leftOverKeys.includes(presentChild)}),exitingChildren.size||!1!==isMounted.current&&(forceRender(),onExitComplete)&&onExitComplete()},custom:custom,presenceAffectsLayout:presenceAffectsLayout,mode:mode},child),exitingChildren.set(key,exitingComponent)),childrenToRender.splice(insertionIndex,0,exitingComponent)}}}),childrenToRender=childrenToRender.map(child=>{var key=child.key;return exitingChildren.has(key)?child:external_React_.createElement(PresenceChild,{key:getChildKey(child),isPresent:!0,presenceAffectsLayout:presenceAffectsLayout,mode:mode},child)}),external_React_.createElement(external_React_.Fragment,null,exitingChildren.size?childrenToRender:childrenToRender.map(child=>(0,external_React_.cloneElement)(child)))};var external_ReactDOM_=__webpack_require__(850),[PortalContextProvider,usePortalContext]=createContext({strict:!1,name:"PortalContext"}),PORTAL_CLASSNAME="chakra-portal",Container=props=>(0,jsx_runtime.jsx)("div",{className:"chakra-portal-zIndex",style:{position:"absolute",zIndex:props.zIndex,top:0,left:0,right:0},children:props.children}),DefaultPortal=props=>{const{appendToParentPortal,children}=props,[tempNode,setTempNode]=(0,external_React_.useState)(null),portal=(0,external_React_.useRef)(null),[,forceUpdate]=(0,external_React_.useState)({}),parentPortal=((0,external_React_.useEffect)(()=>forceUpdate({}),[]),usePortalContext());props=usePortalManager(),dist_useSafeLayoutEffect(()=>{if(tempNode){var doc=tempNode.ownerDocument;const host=appendToParentPortal&&null!=parentPortal?parentPortal:doc.body;if(host){portal.current=doc.createElement("div"),portal.current.className=PORTAL_CLASSNAME,host.appendChild(portal.current),forceUpdate({});const portalNode=portal.current;return()=>{host.contains(portalNode)&&host.removeChild(portalNode)}}}},[tempNode]),props=null!=props&&props.zIndex?(0,jsx_runtime.jsx)(Container,{zIndex:null==props?void 0:props.zIndex,children:children}):children;return portal.current?(0,external_ReactDOM_.createPortal)((0,jsx_runtime.jsx)(PortalContextProvider,{value:portal.current,children:props}),portal.current):(0,jsx_runtime.jsx)("span",{ref:el=>{el&&setTempNode(el)}})},ContainerPortal=props=>{var{children:props,containerRef,appendToParentPortal}=props;const containerEl=containerRef.current,host=null!=containerEl?containerEl:"undefined"!=typeof window?document.body:void 0,portal=(0,external_React_.useMemo)(()=>{var node=null==containerEl?void 0:containerEl.ownerDocument.createElement("div");return node&&(node.className=PORTAL_CLASSNAME),node},[containerEl]),[,forceUpdate]=(0,external_React_.useState)({});return dist_useSafeLayoutEffect(()=>forceUpdate({}),[]),dist_useSafeLayoutEffect(()=>{if(portal&&host)return host.appendChild(portal),()=>{host.removeChild(portal)}},[portal,host]),host&&portal?(0,external_ReactDOM_.createPortal)((0,jsx_runtime.jsx)(PortalContextProvider,{value:appendToParentPortal?portal:null,children:props}),portal):null};function Portal(props){const{containerRef,...rest}={appendToParentPortal:!0,...props};return containerRef?(0,jsx_runtime.jsx)(ContainerPortal,{containerRef:containerRef,...rest}):(0,jsx_runtime.jsx)(DefaultPortal,{...rest})}Portal.className=PORTAL_CLASSNAME,Portal.selector=".chakra-portal";var Action,[ToastOptionProvider,useToastOptionContext]=createContext({name:"ToastOptionsContext",strict:!(Portal.displayName="Portal")}),ToastProvider=props=>{const state=(0,external_React_.useSyncExternalStore)(toastStore.subscribe,toastStore.getState,toastStore.getState),{motionVariants,component:Component=ToastComponent,portalProps}=props;props=Object.keys(state).map(position=>{var toasts=state[position];return(0,jsx_runtime.jsx)("div",{role:"region","aria-live":"polite","aria-label":"Notifications-"+position,id:"chakra-toast-manager-"+position,style:function(position){return{position:"fixed",zIndex:"var(--toast-z-index, 5500)",pointerEvents:"none",display:"flex",flexDirection:"column",margin:"top"===position||"bottom"===position?"0 auto":void 0,top:position.includes("top")?"env(safe-area-inset-top, 0px)":void 0,bottom:position.includes("bottom")?"env(safe-area-inset-bottom, 0px)":void 0,right:position.includes("left")?void 0:"env(safe-area-inset-right, 0px)",left:position.includes("right")?void 0:"env(safe-area-inset-left, 0px)"}}(position),children:(0,jsx_runtime.jsx)(AnimatePresence,{initial:!1,children:toasts.map(toast=>(0,jsx_runtime.jsx)(Component,{motionVariants:motionVariants,...toast},toast.id))})},position)});return(0,jsx_runtime.jsx)(Portal,{...portalProps,children:props})},state_placeholderShown=providerTheme=>function({children,theme=providerTheme,toastOptions,...restProps}){return(0,jsx_runtime.jsxs)(ChakraProvider,{theme:theme,...restProps,children:[(0,jsx_runtime.jsx)(ToastOptionProvider,{value:null==toastOptions?void 0:toastOptions.defaultOptions,children:children}),(0,jsx_runtime.jsx)(ToastProvider,{...toastOptions})]})},chunk_QAITB7GG_ChakraProvider=state_placeholderShown($borderColor),chunk_5MKCW436_Container=(state_placeholderShown(chunk_F7CKIHPM_baseStyle),forwardRef(function(props,ref){const{className,centerContent,...rest}=omitThemingProps(props);props=useStyleConfig("Container",props);return(0,jsx_runtime.jsx)(chakra.div,{ref:ref,className:cx("chakra-container",className),...rest,__css:{...props,...centerContent&&{display:"flex",flexDirection:"column",alignItems:"center"}}})})),es=(chunk_5MKCW436_Container.displayName="Container",__webpack_require__(767)),devtools=__webpack_require__(938);
/**
