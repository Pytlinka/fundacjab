...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "blockart-blocks:";
...
(function () {
  ...
  domReady(function () {
    if ($$('.blockart-modal-wrapper')) {
      __webpack_require__.e(/* import() */ 650).then(__webpack_require__.bind(__webpack_require__, 650)).then(function (_ref) {
        var MicroModal = _ref["default"];
        MicroModal.init();
      });
    }
  });
